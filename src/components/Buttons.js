...
export const SubscribeBtn = () => {
	return <button className="btn activeButton1 subscribeBtn">Subscribe</button>;
};
...
export const SubmitBtn = () => {
	return <button className="btn activeButton1 p-2">Submit</button>;
};

// podcast page buttons
export const PlayBtn = () => {
	return (
		<button className="btn activeButton1 d-flex align-items-center justify-content-center">
			<PlayIcon />
			Play
		</button>
	);
...
export const ReadMoreBtn = () => {
	return <button className="btn activeButton1">Read More</button>;
};

// dashboard page buttons
export const UploadBtn = () => {
	return <button className="btn activeButton1">Upload</button>;
};
...
export const SignUpBtn = () => {
	return <button className="btn activeButton1">Sign Up</button>;
};

export const LoginBtn = () => {
	return <button className="btn activeButton1">Login</button>;
};
