...
export const LoggedInTopMenu = () => {
	return (
		<div className="p-3">
			<div className="container-fluid d-flex align-items-center pt-2 mt-2">
				<img src={logo} width="60px" className="logoStyle ms-2" alt="logo" />
				...
				<img src={logo} className="ms-3 rounded-circle" width="30px" alt="" />
			</div>
...
export const MenuNavbar = () => {
	return (
		<nav className="navbar fixed-top pt-5 mt-5 ms-4 d-none d-sm-none d-md-block">
			<div className="">
...
export const MobileMenuNavbar = () => {
	return (
		<nav className="navbar fixed-top ms-4 mt-4">
			<div className="d-flex align-items-center">
				...
				<div className="">
					<img src={logo} width="50px" className="logoStyle" alt="logo" />
				</div>
			</div>
		</nav>
	);
